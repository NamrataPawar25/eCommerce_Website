...
const ProductInfo = () => {
        ...
        {product ? (
          <div className="row align-items-center g-4">
            ...
            <div className="col-md-6">
              ...
              <div className="mt-3">
                <Link to="likes" className="btn btn-outline-primary me-2">
                  Likes
                </Link>
                <Link to="reviews" className="btn btn-outline-secondary me-2">
                  Reviews
                </Link>
              </div>
            </div>
  ...
  function Likes() {
    return (
      <>
        <div className="mb-3">
          <span className="badge bg-primary fs-6">Likes ⭐⭐⭐⭐</span>
        </div>
      </>
    );
  }
